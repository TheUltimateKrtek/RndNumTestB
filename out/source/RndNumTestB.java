...
static class Application{
    static public class UpdateMessageCode{
        ...
        public static final int getValue(int index){
...
static public class Layout{
    ...
    static abstract public class FontButton extends Button{
        ...
        protected void onDraw(PGraphics pg) {
            ...
            float textWidth = graphics.textWidth(this.getText()) * 0.1f;
            float textSize = (float)Math.min(this.getWidth() / textWidth, this.getHeight());
            ...
            if (this.getAlign() == PConstants.LEFT) {
                graphics.text(this.getText(), this.getLeft(), this.getCenterY() - textSize * 0.05f);
            }
            else if (this.getAlign() == PConstants.RIGHT) {
                graphics.text(this.getText(), this.getRight(), this.getCenterY() - textSize * 0.05f);
            }
            else{
                graphics.text(this.getText(), this.getCenterX(), this.getCenterY() - textSize * 0.05f);
            }
